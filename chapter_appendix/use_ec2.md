...
![]("https://github.com/NRauschmayr/d2l-en/blob/aws_updated/img/aws.png" width="400")

Then click "launch instance" to select the operation system and instance type.

<img src="https://github.com/NRauschmayr/d2l-en/blob/aws_updated/img/ec2.png" width="500"/>
...
<img src="https://github.com/NRauschmayr/d2l-en/blob/aws_updated/img/os.png" width="600"/>
...
<img src="https://github.com/NRauschmayr/d2l-en/blob/aws_updated/img/p2x.png" width="400"/>
...
<img src="https://github.com/NRauschmayr/d2l-en/blob/aws_updated/img/limits.png" width="500"/>
...
<img src="https://github.com/NRauschmayr/d2l-en/blob/aws_updated/img/disk.png" width="500"/>
...
<img src="https://github.com/NRauschmayr/d2l-en/blob/aws_updated/img/keypair.png" width="400"/>

After clicked "launch instances", we can check the status by clicking the
instance ID link.

<img src="https://github.com/NRauschmayr/d2l-en/blob/aws_updated/img/launching.png" width="500"/>

Once the status is green, we can right-click and select "connect" to get the access instruction.

<img src="https://github.com/NRauschmayr/d2l-en/blob/aws_updated/img/connect.png" width="500"/>

With the given address, we can log into our instance:

<img src="https://github.com/NRauschmayr/d2l-en/blob/aws_updated/img/login_screen.png" width="700"/>
