...
For instance, imagine a student, Elephantine Ellie's,
...
(e.g., Imagenet :cite:`deng2009imagenet`),
...
While is no substitute for a proper introduction 
...
to yield improve generalization
...
sampled from distribution $P_(X,Y)$
...
You can think of the test error as 
...
while the test error is expressed as an integral.
