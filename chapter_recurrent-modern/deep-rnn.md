...
Within RNNs this is a bit trickier, since we first need to decide how and where to add extra nonlinearity. Our discussion below focuses primarily on the vallina RNN model, but it applies to other sequence models, too.
