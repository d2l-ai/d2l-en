...
To add insult to injury, bidirectional RNNs are also exceedingly slow. The main reason is that both passes of bidirectional RNNs require a forward propagation and a backward propagation, while the latter depends on the outcomes of the former. Hence, gradients will have a very long dependency chain.
